                  ...
                  <div className="col-lg-7 col-md-8">
                    <div className="abuot-box row">
                      ...
                      <div className="col-lg-8">
                        <p>
                          "Innovation" is a must in today's modern era. This
                          simple word demands a huge result within creating a
                          new works which is called "Invention" .
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            >
              <div className="container">
                <div className="section-head text-center">
                  ...
                  <p>
                    {" "}
                    Success stories from participant joined in our event event{" "}
                  </p>
                </div>
